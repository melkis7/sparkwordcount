A simple Spark application that counts the occurrence of each word in a text file and then counts the
occurrence of each character in the most popular words. Implemented Java and Scala
